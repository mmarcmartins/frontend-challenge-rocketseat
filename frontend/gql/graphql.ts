...
export type ProductQuery = { __typename?: 'Query', Product?: { __typename?: 'Product', id: string, name: string, category: string, description: string, price_in_cents: number, image_url: string, sales: number } | null };
