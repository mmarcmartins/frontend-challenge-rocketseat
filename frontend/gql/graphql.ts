...
export type ProductQuery = { __typename?: 'Query', Product?: { __typename?: 'Product', name: string, category: string, description: string, price_in_cents: number, image_url: string } | null };
